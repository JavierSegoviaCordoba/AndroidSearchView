...
import com.javiersc.androidsearchview.material.extensions.actionBarHeight
import com.javiersc.androidsearchview.material.extensions.color
import com.javiersc.androidsearchview.material.extensions.colorStateList
import com.javiersc.androidsearchview.material.extensions.dimen
...
import com.javiersc.androidsearchview.material.extensions.gone
import com.javiersc.androidsearchview.material.extensions.int
import com.javiersc.androidsearchview.material.extensions.invisible
import com.javiersc.androidsearchview.material.extensions.itemPadding
import com.javiersc.androidsearchview.material.extensions.marginBottom
import com.javiersc.androidsearchview.material.extensions.marginLeft
import com.javiersc.androidsearchview.material.extensions.marginRight
import com.javiersc.androidsearchview.material.extensions.marginTop
import com.javiersc.androidsearchview.material.extensions.setHeight
import com.javiersc.androidsearchview.material.extensions.visible
...
import kotlinx.android.synthetic.main.material_search_view.view.cardViewSuggestion
import kotlinx.android.synthetic.main.material_search_view.view.cardViewUser
...
import kotlinx.android.synthetic.main.material_search_view.view.recyclerViewSuggestionList
...
constructor(context: Context, attributeSet: AttributeSet? = null, defStyleAttr: Int = 0) :
    ...
    fun onSearchTextChanged(text: (String?) -> Unit) {
    ...
    fun onSearchSubmit(text: (String?) -> Unit) {
        onSearchSubmit = { text(it) }
    }
    ...
    // SUGGESTION
    var searchSuggestionIsVisible: Boolean = false
        set(value) {
            field = value.also { cardViewBackground.isVisible = value }
        }
    ...
    fun onSearchSuggestionFilter(text: (String?) -> Unit) {
        onSearchSuggestionFilter = { text(it) }
    }
    ...
    override fun getBehavior(): CoordinatorLayout.Behavior<*> = SearchBehavior(context)
