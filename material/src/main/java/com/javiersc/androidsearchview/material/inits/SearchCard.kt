...
internal fun <T> MaterialSearchView<T>.initSearchCard(attrs: TypedArray) {
    val materialSearchView: MaterialSearchView<T> = this
    with(attrs) {
        val searchCardBackgroundColor: Int = getColor(
        ...
        val searchCardHeight: Float = getDimension(
        ...
        val searchCardCornerRadius: Float = getDimension(
        ...
        val searchCardStrokeWidth: Float = getDimension(
        ...
        val searchCardStrokeColor: Int = getColor(
        ...
        val searchCardShadowColor: Int = getColor(
        ...
        val searchCardElevation: Float = getDimension(
        ...
        val searchCardMarginLeft: Float = getDimension(
        ...
        val searchCardMarginTop: Float = getDimension(
        ...
        val searchCardMarginRight: Float = getDimension(
        ...
        val searchCardMarginBottom: Float = getDimension(
        ...
        val searchCardTranslationY: Float = getDimension(
